...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['updateBtn'])) {
        $selected_request = getRequestById($_POST['reqId']);
    }
...
<div class="container">
  ...
  <form method="post" action="<?php $_SERVER['PHP_SELF'] ?>" onsubmit="return validateInput()">
    <table style="width:98%">
        ...
        <td width="50%">
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' 
                   ...
                   value="<?php if ($selected_request) echo $selected_request['reqDate']; ?>" />
          </div>
        </td>
        <td>
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' id='roomNo' name='roomNo' 
                   value="<?php if ($selected_request) echo $selected_request['roomNumber']; ?>" />
          </div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' id='requestedBy' name='requestedBy'
                   ...
                   value="<?php if ($selected_request) echo $selected_request['reqBy']; ?>" />
          </div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
          <div class="mb-3">
            ...
            <input type='text' class='form-control' id='requestDesc' name='requestDesc'
                   value="<?php if ($selected_request) echo $selected_request['repairDesc']; ?>" />
        </div>
        </td>
      </tr>
      <tr>
      ...
      <input type="hidden" name="reqId" value="<?php if ($selected_request) echo $selected_request['reqId']; ?>">
    </table>
  ...
  <tr>
    ...
    <td>
      <form action="request.php" method="post">
        ...
        <input class="btn btn-warning" type="submit" name="updateBtn" value="Update" title="Click to edit this request">
      </form>
    </td>
    <td>
      <form action="request.php" method="post">
        <input class="btn btn-danger" type="submit" name="deleteBtn" value="Delete" title="Click to delete this request">
        <input type="hidden" name="reqId" value="<?php echo $req_info['reqId']; ?>">
      </form>
    </td>
  </tr>
